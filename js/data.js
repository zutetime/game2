...
const jobBaseData = {
    ...
    "Imperator": { name: "Imperator", maxXp: 5e27, income: 2.5e62, heroxp: 129 },
...
const skillBaseData = {
    ...
    "Bargaining": { name: "Bargaining", maxXp: 100, heroxp: 38, effect: -1.01, description: "Reduced Expenses" },
    ...
    "Astral Body": { name: "Astral Body", maxXp: 100, heroxp: 100, effect: 10.0035, description: "Longer lifespan" },
    "Temporal Dimension": { name: "Temporal Dimension", maxXp: 100, heroxp: 115, effect: 10.006, description: "Gamespeed" },
    "All Seeing Eye": { name: "All Seeing Eye", maxXp: 100, heroxp: 120, effect: 1.1027, description: "T.A.A Pay" },
    "Brainwashing": { name: "Brainwashing", maxXp: 100, heroxp: 145, effect: -1.01, description: "Reduced Expenses" },

    "Dark Influence": { name: "Dark Influence", maxXp: 100, heroxp: 155, effect: 1.01, description: "All XP" },
    "Evil Control": { name: "Evil Control", maxXp: 100, heroxp: 156, effect: 1.01, description: "Evil Gain" },
    "Intimidation": { name: "Intimidation", maxXp: 100, heroxp: 157, effect: -1.01, description: "Reduced Expenses" },
    "Demon Training": { name: "Demon Training", maxXp: 100, heroxp: 174, effect: 1.01, description: "All XP" },
    "Blood Meditation": { name: "Blood Meditation", maxXp: 100, heroxp: 176, effect: 1.01, description: "Evil Gain" },
    ...
    "Essence Collector": { name: "Essence Collector", maxXp: 100, heroxp: 288, effect: 1.01, description: "Essence Gain" },
    ...
    "Dark Prince": { name: "Dark Prince", maxXp: 100, heroxp: 350, effect: 1.01, description: "Skill XP" },
    "Dark Ruler": { name: "Dark Ruler", maxXp: 100, heroxp: 375, effect: 1.0000015, description: "Dark Matter Gain" },
    "Immortal Ruler": { name: "Immortal Ruler", maxXp: 100, heroxp: 425, effect: 1.01, description: "All XP" },
    "Dark Magician": { name: "Dark Magician", maxXp: 100, heroxp: 475, effect: 1.0000025, description: "Essence Gain" },
...
const itemBaseData = {
    ...
    "Tent": { name: "Tent", expense: 0, effect: 10.4, heromult: 40, heroeffect: 2e7 },
